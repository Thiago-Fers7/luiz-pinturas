      ...
      <div className="flex w-full flex-col gap-10 md:flex-row">
        <div className="w-full space-y-2 text-slate-600 md:w-2/3">
          ...
          <p>
            ...
            Com anos de experiência no mercado, ofereço serviços personalizados,
            garantindo que cada projeto receba o cuidado e a atenção que merece.
          </p>

          <p>
            Desde a escolha das cores até o acabamento final, estou presente em
          ...
          <div className="w-[300px] rounded-lg border border-gray-200 bg-slate-100 p-5 shadow">
            ...
            <div className="">
              ...
              <p className="mt-2 text-sm font-normal text-slate-700">
                ...
                experiência, ele combina técnica, precisão e velocidade em cada
                projeto. Seu compromisso com a excelência garante que cada
                projeto, seja grande ou pequeno seja concluído com eficiência e
                qualidade.
              </p>
            </div>
          </div>
